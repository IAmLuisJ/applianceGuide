...
const searchTemplateURL =
  "https://www.bestbuy.com/site/searchpage.jsp?st=XXXXXX&_dyncharset=UTF-8&_dynSessConf=&id=pcat17071&type=page&sc=Global&cp=1&nrp=&sp=&qp=&list=n&af=true&iht=y&usc=All+Categories&ks=960&keys=keys";
    ...
    <header className="text-white body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center bg-blue-700">
        ...
        <nav className="flex flex-wrap items-center text-lg justify-center">
          <Link className="text-center mr-5 hover:text-gray-900" to="/">
            Home
          </Link>
          <Link
          ...
          <Link
            ...
            to="https://www.bestbuy.com/site/home-appliances/kitchen-appliance-packages/pcmcat302600050005.c?id=pcmcat302600050005"
          >
            Appliance Bundles
          </Link>
        </nav>
        ...
        <div
          class="search"
          style={{ color: "#0046be", overflow: "auto", marginLeft: "75px" }}
        >
          <input
            type="text"
            id="searchBox"
